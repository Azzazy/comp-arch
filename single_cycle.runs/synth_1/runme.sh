...
HD_PWD='C:/Users/msa.azzazy.AUC/single_cycle/single_cycle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DataPath_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DataPath_Demo.tcl
