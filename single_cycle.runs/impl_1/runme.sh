...
HD_PWD='C:/Users/msa.azzazy.AUC/single_cycle/single_cycle.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DataPath_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DataPath_Demo.tcl -notrace
